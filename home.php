...
*/
	...
	$xmlPathDebug = AppSettings::get_pathToWebRoot(). "debug/root.xml";
	$fileOutput = AppSettings::get_pathToWebRoot(). "html/index.htm";
    ...
    // echo $engine->xTransformOptIntlWithParams( $xmlPath, $xslPath, array($xmlFileLang, $xslFileLang), $params, $fileOutput );
?>
